    ...
    if (ok1 && ok2 && ok3 && ok4 == true){
        ...
        xhr.onload = function() {
            if (xhr.response == "Your Email Already Exist's"){
                let email = document.getElementById('email_error').innerHTML = "Your Email Already Exists"
            }
            else if (xhr.response == "Your Username Already Exist's"){
                let username_error = document.getElementById("username_error").innerHTML = "Your Username Already Exists"
            }else{
